...
> This project is a webpack boilerplate, which i can later use as a starting point in my future projects.
...
4. Clone the repo using the below command
 > git clone  https://github.com/MNisarAli/Set-up-webpack-config.git
...
Feel free to check the [issues page](https://github.com/MNisarAli/Set-up-webpack-config/issues).
